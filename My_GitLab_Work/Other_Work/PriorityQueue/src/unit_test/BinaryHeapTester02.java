 ...
 * @author Meijad
 */
public class BinaryHeapTester02 {
	@Test
	public void test01() { //Check the method size()
		MaxPriorityQueue<String,Integer> H = new MaxHeap<>();
		assertEquals( H.size(), 0 );
	}
	
	@Test
	public void test02() { //Check the methods Clear() and Empty()
		MaxPriorityQueue<Integer, Integer> H = new MaxHeap<>();
	...
	public void test08() { //check Iterator(), clone(), find(), and contains()
		...
		for ( int i = 0; i < 500; i ++ )
			H.add( i, ( int ) ( rand.nextInt( ( max - min ) + 1 ) + min ) );
		MaxPriorityQueue<Integer, Integer> H2 = new MaxHeap<>();
		try {
