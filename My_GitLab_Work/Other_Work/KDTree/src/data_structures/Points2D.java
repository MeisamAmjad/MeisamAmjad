...
/**
 * <p>The <b>Points2D class</b> defines a point representing a location or a coordinate (x,y) on space. </br>
...
public class Points2D implements Comparable<Points2D>{
	 ...
	 * @param newNode Points2D object.
	 */
	public Points2D ( Points2D newPoint ) {
		super();
		setX( newPoint.getX() );
		setY( newPoint.getY() );
	}
	...
	/**
	 * <p> Acts as a copy constructor and sets the location of this Points2D to the given double coordinates.</p>
	 * @param x A new double value for x coordinate.
	 * @param y A new double value for y coordinate.
	 */
	 ...
	 */
	public double distance( Points2D p2 ) {
	 ...
	 * @param p1 Points2D object
	 * @param p2 Points2D object
	 * @return <b>double </b></br> Distance in <b>km</b>.
	 * @see <a href="https://en.wikipedia.org/wiki/Geographical_distance">Geographical distance (Wikipedia)</a
	 */
	public double GeographicalDistance( Points2D p1, Points2D p2 ) {
	 ...
	 * @param other Points2D object
	 * @return <b>double </b></br> Distance in <b>km</b>.
	 * @see <a href="https://en.wikipedia.org/wiki/Geographical_distance">Geographical distance (Wikipedia)</a
	 */
	public double GeographicalDistance( Points2D other ) {
	 ...
	 */
	@Override
	public int compareTo( Points2D p2 ) {
	...
	public boolean equals( Object obj ) {
		if ( ( obj == null ) || ( this == null ) || !( obj instanceof Points2D ) )
			return false;
		Points2D point = ( Points2D ) obj;
	...
	public static Comparator<Points2D> X_Comparator = new Comparator<Points2D>() {
		 ...
		 */
		@Override
		public int compare(Points2D o1, Points2D o2) {
			if ( o1.getX() < o2.getX() )
				return -1;
			if ( o1.getX() > o2.getX() )
				return 1;
