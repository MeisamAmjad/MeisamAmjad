...
public class KDTNode implements Comparable<KDTNode>{
	 ...
	 * @see #getPoint()
	 * @see #setPoint(Points2D point)
	 */
	private Points2D point = new Points2D();
	 ...
	 * @see #getParent()
	 * @see #getGreater()
	 * @see #setLesser(Points2d lesser)
	 * @see #setParent(Points2D parent)
	 * @see #setGreater(Points2D greater)
	 */
	 ...
	 * @param point The Points2D object.
	 */
	public KDTNode( Points2D point ) {
		super();
		setPoint( point );
		setAxis( Axis.XAxis );
	}
	 ...
	 * @see #point
	 */
	protected Points2D getPoint() { return this.point;	}
	
	/**
	 * @see #point
	 */
	protected void setPoint( Points2D point ) { this.point = point; }
	...
	public int compareTo( KDTNode o ) {
		switch( getAxis() ) {
			case XAxis:
				return Points2D.X_Comparator.compare( this.getPoint(), o.getPoint() );
			case YAxis:
				return Points2D.Y_Comparator.compare( this.getPoint(), o.getPoint() );
		}
