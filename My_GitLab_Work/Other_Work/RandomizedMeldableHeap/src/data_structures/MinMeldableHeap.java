 ...
 * @param <V>
 */
public class MinMeldableHeap< K extends Comparable<K>, V extends Comparable<V>> implements Iterable<PairNode<K, V>>, MeldableHeap<K, V>, MinPriorityQueue<K, V> {
	/**
	 ...
	 * <p> Constructor.</p>
	 */
	public MinMeldableHeap( Collection<?> C ) {
		super();
		addAll( C );
	}
	 ...
	 * <p> Constructor.</p>
	 */
	protected MinMeldableHeap ( MinMeldableHeap<K, V> newMH ) {
		super();
	...
	public Object clone() throws CloneNotSupportedException {
		...
		MinMeldableHeap<K, V> newHeap = new MinMeldableHeap<>();
