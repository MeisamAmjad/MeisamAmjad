...
public class BSTTester {
	...
	public void testInOrder(){
		...
		assertTrue(T.check_structure());
		ArrayList<TreeNode<Integer, Integer>> RList=T.inOrderSortRecursive();
		ArrayList<TreeNode<Integer, Integer>> RTravers=T.inOrderSortTravers();
	...
	public void testPreOrder(){
		BST<Integer, Integer> T=create_BST(50);
		assertTrue(T.check_structure());
		ArrayList<TreeNode<Integer, Integer>> RList=T.preOrderRecursive();
		ArrayList<TreeNode<Integer, Integer>> RTravers=T.preOrderTravers();
		assertTrue(RList.size()==RTravers.size());
		for(int i=0;i<RList.size();i++){
			assertTrue( RList.get(i).getKey()==RTravers.get(i).getKey() 
					&&	RList.get(i).getValue()==RTravers.get(i).getValue() );
	...
	public void testDeepCopy(){
		...
		TreeNode<Integer, Integer> dcpyT = T.deepCopyRecursive_preOrder();
		BST<Integer, Integer> newT=new BST<>(dcpyT);
		
		ArrayList<TreeNode<Integer, Integer>> originList=T.preOrderRecursive();
		ArrayList<TreeNode<Integer, Integer>> newList=newT.preOrderRecursive();
	...
	public void testPostOrder(){
		...
		assertTrue(T.check_structure());
		ArrayList<TreeNode<Integer, Integer>> preLOld=T.preOrderRecursive();
		ArrayList<TreeNode<Integer, Integer>> inLOld=T.inOrderSortRecursive();
		
		TreeNode<Integer, Integer> dcpyT = T.deepCopyRecursive_preOrder();
		BST<Integer, Integer> newT=new BST<>(dcpyT);
		
		ArrayList<TreeNode<Integer, Integer>> RList=newT.postOrderRecursive();
		ArrayList<TreeNode<Integer, Integer>> RTravers=newT.postOrderTravers();
		assertTrue(RList.size()==RTravers.size());
		for(int i=0;i<RList.size();i++){
			assertTrue( RList.get(i).getKey()==RTravers.get(i).getKey() 
					&&	RList.get(i).getValue()==RTravers.get(i).getValue() );
		...
		ArrayList<TreeNode<Integer, Integer>> preLNew=T.preOrderRecursive();
		ArrayList<TreeNode<Integer, Integer>> inLNew=T.inOrderSortRecursive();
	...
	public void deepCopyTester(){
		...
		ArrayList<TreeNode<Integer, Integer>> postOrderT = newT1.postOrderTravers();
		assertTrue( compareTrees( T.getRoot(), newT2.getRoot() ) );
	...
	public void randomTreemakerTest(){
		BST<Integer, Integer> T1 = new IntBST( 501 );
	...
	private boolean compareTrees( TreeNode<Integer, Integer> T1, TreeNode<Integer, Integer> T2){
