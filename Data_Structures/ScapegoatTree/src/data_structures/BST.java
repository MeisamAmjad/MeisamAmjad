...
public class BST<K extends Comparable<K>,V extends Comparable<V>> extends Dictionary<K, V> {
	 ...
	 * @param prev
	 */
	protected final void splice(BSTNode<K, V> removingNode, BSTNode<K, V> parentNode) {
	...
	public void remove(K key) {
		...
		BSTNode<K, V> parentNode = findParent(key), removingNode;
	...
	public BSTNode<K, V> deepCopy( BSTNode<K, V> root ){
		return ( root == null )
				? null
				: new BSTNode<K, V>( root.getKey(), root.getValue(), deepCopy( root.getLeft() ), deepCopy( root.getRight() ) );
	}
	/**
