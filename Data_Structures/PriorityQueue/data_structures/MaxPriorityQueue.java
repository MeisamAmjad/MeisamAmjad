...
/**
 * <p>******** This class had been implemented by MinHeap.java class from <b>BinaryHeap</b> {@link MaxHeap} and maxMeldableHeap.java class from <b>RandomizedMeldableHeap</b> {@link MaxMeldableHeap}************** </p>
 ...
 * @param <V>
 */
public interface MaxPriorityQueue<K extends Comparable<K>, V extends Comparable<V>> {
	
	/**
	 * <p> Removes the entity with the maximum priority and returns it. Also, reorganizes the queue for maintaining the Priority Queue property.</p>   
	 * @return
	...
	/**
	 * <p> Adds an entity at the end of the list. Ensuring the list maintains the Max Priority Queue property.</p>
	 * @param entry
	 * @param priority
	...
	/**
	 * <p> Makes a deep copy of the Max Priority Queue Object.</p>
